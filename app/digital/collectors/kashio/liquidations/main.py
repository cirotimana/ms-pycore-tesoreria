from app.digital.collectors.kashio.liquidations.analysis import *
from datetime import datetime, timedelta
import pytz

def get_main_kashio_liq(from_date = None, to_date = None):
    ...
    try:
        results = {
            'kashio': get_kashio_liq(from_date, to_date),
        }
        
        print(f"[DEBUG] Resultados: Kashio={results['kashio']}")
