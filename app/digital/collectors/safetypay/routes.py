from app.digital.collectors.safetypay.tasks import task_process_safetypay, task_process_updated_safetypay
...
@router.get("/execute-getsafetypay")
@redis_lock("safetypay-process")
def execute_get_safetypay(from_date: str = None, to_date: str = None):
    try:
        task = task_process_safetypay.delay(from_date, to_date)
        logger.info(LOG_TASK_STARTED.format(task_name="task_process_safetypay", task_id=task.id))
...
@router.get("/execute-updated-safetypay")
@redis_lock("safetypay-process")
def execute_updated_safetypay():
    try:
        task = task_process_updated_safetypay.delay()
        logger.info(LOG_TASK_STARTED.format(task_name="task_process_updated_safetypay", task_id=task.id))
