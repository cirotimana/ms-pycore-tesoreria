from app.digital.collectors.tupay.liquidations.analysis import *
from datetime import datetime, timedelta
import pytz

def get_main_tupay_liq(from_date = None, to_date = None):
    ...
    try:
        results = {
            'tupay': get_tupay_liq(from_date, to_date),
        }
        
        print(f"[DEBUG] Resultados: Tupay={results['tupay']}")
