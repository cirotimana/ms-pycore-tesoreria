...
def send_liquidation_email(s3_key, metricas, period):
    ...
    subject = f'Liquidacion Tupay {period}'
    recipients = Config.CORREO_TUPAY_LIQ.split(',')
    mensaje_html = f"""
    <!DOCTYPE html>
    <html>
    <head>
        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#233DB4">
            <tr>
                <td align="center" style="padding: 15px;">
                    <h1 style="color: white; margin: 0;">Reporte de Liquidacion Tupay</h1>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #28a745; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total Credito Tupay:</strong> <span style="color: #28a745; font-weight: bold;">S/. {round(metricas['total_credito_tupay'],2)}</span></p>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #dc3545; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total Debito Tupay:</strong> <span style="color: #dc3545; font-weight: bold;">S/. {round(metricas['total_debito_tupay'],2)}</span></p>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#e8f4fd" style="margin-bottom: 15px; border-left: 4px solid #007bff; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total Neto Tupay:</strong> <span style="color: #007bff; font-weight: bold;">S/. {round(metricas['total_neto_tupay'],2)}</span></p>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#fff3cd" style="margin-bottom: 20px; border-left: 4px solid #ffc107; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #856404;">Diferencia Credito:</strong> <span style="color: #856404; font-weight: bold;">S/. {round(metricas['total_credito_tupay'] - metricas['total_credito_liquidacion'],2)}</span></p>
                                <p><strong style="color: #856404;">Diferencia Debito:</strong> <span style="color: #856404; font-weight: bold;">S/. {round(metricas['total_debito_tupay'] - metricas['total_debito_liquidacion'],2)}</span></p>
                                <p><strong style="color: #856404;">Diferencia Neto:</strong> <span style="color: #856404; font-weight: bold;">S/. {round(metricas['total_neto_tupay'] - metricas['total_neto_liq'],2)}</span></p>
                            </td>
                        </tr>
                    </table>
...
#     metricas = {
#         'total_credito_tupay': 42255309.8155,
#         'total_credito_liquidacion': 42255309.81555,
#         'total_debito_tupay': 153202.758888,
#         'total_debito_liquidacion': 152052.7577,
#         'total_neto_tupay': 4071888.778445,
