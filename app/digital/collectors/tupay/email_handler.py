...
def send_email_with_results(s3_key, metricas, period):
    ...
    subject = f'Conciliacion Tupay  {period}'
    recipients = Config.EMAIL_TUPAY.split(',')
    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; color: #333;">
        <!-- Encabezado -->
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#233db4">
            <tr>
                <td align="center" style="padding: 15px;">
                    <h1 style="color: white; margin: 0;">Reporte de Conciliacion Tupay vs Calimaco</h1>
        ...
        <table width="100%" cellpadding="20" cellspacing="0" style="border: 1px solid #ddd; border-top: none;">
            <tr>
                <td>                   
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #233db4; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total registros Tupay:</strong> <span style="color: #2C3E50; font-weight: bold;">{metricas['total_tupay']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #233db4; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Tupay:</strong> <span style="color: #2C3E50; font-weight: bold;">{metricas['aprobados_tupay']}</span></p>
                            </td>
                        </tr>
                    </table>
                    
                    <!-- Seccion Recaudacion (destacada) -->
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#e8f4fd" style="margin-bottom: 15px; border-left: 4px solid #233db4; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Tupay:</strong> <span style="color: #2C3E50; font-weight: bold;">S/. {metricas['recaudacion_tupay']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#eafaf1" style="margin-bottom: 15px; border-left: 4px solid #27ae60; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #27ae60;">Monto Tupay:</strong> <span style="color: #27ae60; font-weight: bold;">S/. {metricas['conciliados_monto_tupay']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#fdeaea" style="margin-bottom: 15px; border-left: 4px solid #e74c3c; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #e74c3c;">Tupay:</strong> <span style="color: #e74c3c; font-weight: bold;">{metricas['no_conciliados_tupay']}</span></p>
                            </td>
                        </tr>
                    </table>
    ...
    # Enviar correo SIN adjunto (solo con enlace de descarga)
    send_mail_office_365(Config.SMTP_USER, subject, mensaje_html, recipients, None)
    print(f"[âœ”] Email enviado con enlace de descarga para {filename}")
...
def send_email_with_results_month(s3_key, metricas, period):
    ...
    subject = f'Conciliacion Tupay para el periodo {period}'
    recipients = Config.EMAIL_TUPAY.split(',')
...
if __name__ == "__main__":
    ...
    s3_key = "digital/apps/total-secure/conciliaciones/processed/Conciliacion_completa_Tupay_20250922_1057_MES.xlsx"
    metricas = {
        "total_calimaco": 100,
        "total_tupay": 120,
