...
def send_email_with_results(s3_key, metricas, period):
    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; color: #333;">
        <!-- Encabezado -->
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#00e6b2">
            <tr>
                <td align="center" style="padding: 15px;">
                    <h1 style="color: white; margin: 0;">Reporte de Conciliacion Kushki vs Calimaco</h1>
        ...
        <table width="100%" cellpadding="20" cellspacing="0" style="border: 1px solid #ddd; border-top: none;">
            <tr>
                <td>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #00e6b2; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total registros Kushki:</strong> <span style="color: #2C3E50; font-weight: bold;">{metricas['total_kushki']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #00e6b2; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Kushki:</strong> <span style="color: #2C3E50; font-weight: bold;">{metricas['aprobados_kushki']}</span></p>
                            </td>
                        </tr>
                    </table>
                    
                    <!-- Seccion Recaudacion (destacada) -->
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#e8f4fd" style="margin-bottom: 15px; border-left: 4px solid #00e6b2; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Kushki:</strong> <span style="color: #2C3E50; font-weight: bold;">S/. {metricas['recaudacion_kushki']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#eafaf1" style="margin-bottom: 15px; border-left: 4px solid #27ae60; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #27ae60;">Monto Kushki:</strong> <span style="color: #27ae60; font-weight: bold;">S/. {metricas['conciliados_monto_kushki']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#fdeaea" style="margin-bottom: 15px; border-left: 4px solid #e74c3c; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #e74c3c;">Kushki:</strong> <span style="color: #e74c3c; font-weight: bold;">{metricas['no_conciliados_kushki']}</span></p>
                            </td>
                        </tr>
                    </table>
...
if __name__ == "__main__":
    ...
    metricas = {
        ...
        "recaudacion_kushki": 1600.75,
        "conciliados_total": 70,
        "conciliados_monto_calimaco": 1200.00,
        "conciliados_monto_kushki": 1250.00,
        "no_conciliados_calimaco": 30,
        "no_conciliados_kushki": 40
    }
    period = "2025-08-21"
