        ...
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#FFCC00">
            <tr>
                <td align="center" style="padding: 15px;">
                    <h1 style="color: white; margin: 0;">Reporte de Liquidacion PagoEfectivo</h1>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #28a745; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total Credito PagoEfectivo:</strong> <span style="color: #28a745; font-weight: bold;">S/. {round(metricas['total_credito_pagoefectivo'],2)}</span></p>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #dc3545; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total Debito PagoEfectivo:</strong> <span style="color: #dc3545; font-weight: bold;">S/. {round(metricas['total_debito_pagoefectivo'],2)}</span></p>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#e8f4fd" style="margin-bottom: 15px; border-left: 4px solid #007bff; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total Neto PagoEfectivo:</strong> <span style="color: #007bff; font-weight: bold;">S/. {round(metricas['total_neto_pagoefectivo'],2)}</span></p>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#fff3cd" style="margin-bottom: 20px; border-left: 4px solid #ffc107; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #856404;">Diferencia Credito:</strong> <span style="color: #856404; font-weight: bold;">S/. {round(metricas['total_credito_pagoefectivo'] - metricas['total_credito_liquidacion'],2)}</span></p>
                                <p><strong style="color: #856404;">Diferencia Debito:</strong> <span style="color: #856404; font-weight: bold;">S/. {round(metricas['total_debito_pagoefectivo'] - metricas['total_debito_liquidacion'],2)}</span></p>
                                <p><strong style="color: #856404;">Diferencia Neto:</strong> <span style="color: #856404; font-weight: bold;">S/. {round(metricas['total_neto_pagoefectivo'] - metricas['total_neto_liq'],2)}</span></p>
                            </td>
                        </tr>
                    </table>
...
if __name__ == "__main__":
    metricas = {
        'total_credito_pagoefectivo': 42255309.8155,
        'total_credito_liquidacion': 42255309.81555,
        'total_debito_pagoefectivo': 153202.758888,
        'total_debito_liquidacion': 152052.7577,
        'total_neto_pagoefectivo': 4071888.778445,
        'total_neto_liq': 4071057.0655,
        'resultado': 'CONCILIACION EXITOSA',
        'referencias' : [222,333,444]
    }
