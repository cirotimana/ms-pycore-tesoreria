...
def send_email_with_results(s3_key, metricas, period):
    ...
    subject = f'Conciliacion Monnet  {period}'
    recipients = Config.CORREO_MONNET.split(',')
    mensaje_html = f"""
    <!DOCTYPE html>
    <html>
    <head>
    ...
    <body style="font-family: Arial, sans-serif; margin: 0; padding: 0; color: #333;">
        <!-- Encabezado -->
        <table width="100%" cellpadding="0" cellspacing="0" bgcolor="#3d5afe">
            <tr>
                <td align="center" style="padding: 15px;">
                    <h1 style="color: white; margin: 0;">Reporte de Conciliacion Monnet vs Calimaco</h1>
        ...
        <table width="100%" cellpadding="20" cellspacing="0" style="border: 1px solid #ddd; border-top: none;">
            <tr>
                <td>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #3d5afe; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Total registros Monnet:</strong> <span style="color: #2C3E50; font-weight: bold;">{metricas['total_monnet']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#f9f9f9" style="margin-bottom: 15px; border-left: 4px solid #3d5afe; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Monnet:</strong> <span style="color: #2C3E50; font-weight: bold;">{metricas['aprobados_monnet']}</span></p>
                            </td>
                        </tr>
                    </table>
                    
                    <!-- Seccion Recaudacion (destacada) -->
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#e8f4fd" style="margin-bottom: 15px; border-left: 4px solid #3d5afe; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #2c3e50;">Monnet:</strong> <span style="color: #2C3E50; font-weight: bold;">S/. {metricas['recaudacion_monnet']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#eafaf1" style="margin-bottom: 15px; border-left: 4px solid #27ae60; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #27ae60;">Monto Monnet:</strong> <span style="color: #27ae60; font-weight: bold;">S/. {metricas['conciliados_monto_monnet']}</span></p>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table width="100%" cellpadding="15" cellspacing="0" bgcolor="#fdeaea" style="margin-bottom: 15px; border-left: 4px solid #e74c3c; border-radius: 5px;">
                        <tr>
                            <td>
                                ...
                                <p><strong style="color: #e74c3c;">Monnet:</strong> <span style="color: #e74c3c; font-weight: bold;">{metricas['no_conciliados_monnet']}</span></p>
                            </td>
                        </tr>
                    </table>
...
def send_email_with_results_month(s3_key, metricas, period):
    ...
    subject = f'Conciliacion Monnet para el periodo {period}'
    recipients = Config.CORREO_MONNET.split(',')
    mensaje_html = f"""
    <!DOCTYPE html>
    <html>
...
if __name__ == "__main__":
    ...
    metricas = {
        ...
        "recaudacion_monnet": 1600.75,
        "conciliados_total": 70,
        "conciliados_monto_calimaco": 1200.00,
        "conciliados_monto_monnet": 1250.00,
        "no_conciliados_calimaco": 30,
        "no_conciliados_monnet": 40
    }
    period = "2025-08-21"
